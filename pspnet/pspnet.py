...
class PSPNet(object):
        ...
        if isfile(json_path) and isfile(h5_path):
            ...
            with open(json_path, "r") as file_handle:
                try:
                    ...
                    print("Couldn't import model from json because it was built using a different python version: %s" % err)
    ...
    def set_npy_weights(self, weights_path):
        ...
        weights = np.load(npy_weights_path, encoding = 'latin1', allow_pickle = True).item()
