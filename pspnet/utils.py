...
def download_weights(name):
    ...
    for key in link_dict:
        if name in key:
            ...
            np.save(join("..", "weights", "keras", key), response.content)
...
def download_npy_weights(name):
    ...
    print("Downloading Keras weights from Dropbox ...")
    link_dict = {'pspnet50_ade20k.npy': 'https://www.dropbox.com/s/slzgd07ijcyl45b/pspnet50_ade20k.npy?dl=0',
                 'pspnet101_cityscapes.npy': 'https://www.dropbox.com/s/gdtjzjkox999xpg/pspnet101_cityscapes.npy?dl=0',
                 'pspnet101_voc2012.npy': 'https://www.dropbox.com/s/ff6hdkhxz8h5si1/pspnet101_voc2012.npy?dl=0'}
